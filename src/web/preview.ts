...
export class PreviewModal {
    ...
    constructor(client: any, storagePeer = "me") {
        this.client = client
        this.storagePeer = storagePeer.trim() || "me"
    ...
    private async streamToMedia(
        ...
        const chunkMsgs: Api.messages.Messages = await this.client.getMessages(this.storagePeer, { ids: data.chunks })
